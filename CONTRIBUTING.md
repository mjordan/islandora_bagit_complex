# Contributing to Islandora BagIt Complex

All contributions to Islandora BagIt Complex are welcome: use-cases, documentation, code, bug reports, feature requests, etc. You do not need to be a programmer to contribute!
...
If you use Islandora BagIt Complex and you have documented a task for yourself, consider sharing it with other users. We'd be happy to include your contribution in the Islandora BagIt Complex README or link to it if you'd rather maintain it somewhere else.
...
Contributions to the Islandora BagIt Complex codebase should be sent as GitHub pull requests. See section _Create a pull request_ below for details. If there is any problem with the pull request we can work through it using the commenting features of GitHub.
...
* For all code contributions, please use the following process in order to to prevent any wasted work and catch design issues early on.
    ...
    3. The Islandora BagIt Complex maintainers will work with you on the design to make sure you are on the right track.
...
1. [Fork](https://help.github.com/articles/fork-a-repo) the Islandora BagIt Complex repository to your personal GitHub account. See [Fork a repo](https://help.github.com/articles/fork-a-repo) for detailed instructions.
...
3. Send a [pull request](https://help.github.com/articles/creating-a-pull-request) to the Islandora BagIt Complex repository that you forked in step 1 (in other words, https://github.com/mjordan/islandora_context).
4. Complete the pull request template.

You may want to read [Syncing a fork](https://help.github.com/articles/syncing-a-fork) for instructions on how to keep your fork up to date with the latest changes of the upstream (official) Islandora BagIt Complex repository.

### Workflow for testing and merging pull requests

Smoke tests are required for the work you are contributing. In other words, a human needs to test your work to confirm it does what it is intended to do and that it doesn't introduce any side effects. You are expected to provide sample Islandora BagIt Complex commands and, if applicable, input data to allow the reviewer to perform the smoke tests.

## License Agreements

Islandora BagIt Complex is licensed under GPL version 3 or higher. By opening a pull request or otherwise contributing code to the Islandora BagIt Complex codebase, you transfer non-exclusive ownership of that code (you retain ownership of your code for other purposes) to the Islandora BagIt Complex maintainers for the sole purpose of redistributing your contribution within the Islandora BagIt Complex codebase under the conditions of the GPLv3 license or higher. You also warrant that you have the legal authority to make such a transfer.
